...
import HeaderView, { HeaderButton } from "@_views/header.jsx"
...
const MainProjectMapInitialView = () => {
    ...
    const onSubmit = useCallback(() => {
        setProject({
            longitude: confirmCenter.current.lng,
            latitude: confirmCenter.current.lat,
        })
        _.waited(() => {
    ...
    return (
        <Box style={styles.root}>
            <HeaderView title="【新規プロジェクト】">
                <HeaderButton name="キャンセル" onClick={() => setProject(null)} />
            </HeaderView>
                ...
                {openConfirm && (
                    <Box sx={styles.confirm.box}>
                        ...
                        <Box sx={styles.confirm.buttons}>
                            <HeaderButton sx={{ ...styles.confirm.button }} name="はい" onClick={onSubmit} />
                            <HeaderButton sx={{ ...styles.confirm.button }} name="キャンセル" onClick={onCancel} />
                        </Box>
                    </Box>
                )}
            </Box>
