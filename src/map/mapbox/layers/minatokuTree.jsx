...
import { UseApiManager, useMaplibre, OverwriteMode , AppDataContext} from "@team4am/fp-core"

const SourceName = "minatoku-tree"

export const LayerName = {
    Circle: {id: "minatoku-tree-circle-layer", at: 2},
    Buffer: {id: "minatoku-tree-buffer-layer", at: 1},
}

const MapMinatokuTreeLayer = ({map, filter, visible, style, onClick, onInit}) => {
...
MapMinatokuTreeLayer.propTypes = {
    ...standardLayerProps,
    filter: PropTypes.array,
    onClick: PropTypes.func,
}

export default MapMinatokuTreeLayer
